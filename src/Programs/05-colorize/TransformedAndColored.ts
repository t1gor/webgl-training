...
import ITransformAndColoredOptions from './ITransformAndColoredOptions';
...
class TransformedAndColored implements IProgram {
	private options: ITransformAndColoredOptions;
	...
	init(
		...
		options: ITransformAndColoredOptions
	) {
		this._gl = gl;
...
export default TransformedAndColored;
